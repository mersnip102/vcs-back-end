...
} = require("../controllers/to_chuc/to_chuc.controller");
const ImageReport = require("../models/bao_cao_hinh_anh.model");

const toChucRouter = express.Router();
...
toChucRouter.post('/uploadBaoCaoHinhAnh', uploadFile.array('File'), validateEmptyBaoCao, async(req, res) => {
   try {
        let files = req.files
